...
var File = /** @class */ (function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        filePath = params.width && params.height
                            ? path_1.default.resolve(File.imagesThumbPath, "".concat(params.filename, "-").concat(params.width, "x").concat(params.height, ".jpg"))
                            : path_1.default.resolve(File.imagesFullPath, "".concat(params.filename, ".jpg"));
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        filePath = path_1.default.resolve(File.imagesThumbPath, "".concat(params.filename, "-").concat(params.width, "x").concat(params.height, ".jpg"));
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, fs_1.promises.access(filePath)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        filePathFull = path_1.default.resolve(File.imagesFullPath, "".concat(params.filename, ".jpg"));
                        filePathThumb = path_1.default.resolve(File.imagesThumbPath, "".concat(params.filename, "-").concat(params.width, "x").concat(params.height, ".jpg"));
    ...
    File.imagesFullPath = path_1.default.resolve(__dirname, '../images/full');
