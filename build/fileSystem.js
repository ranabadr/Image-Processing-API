                            ...
                            params.width && params.height
                                ? path_1.default.resolve(
                                      ...
                                      ''
                                          ...
                                          .concat(params.width, 'x')
                                          .concat(params.height, '.jpg')
                                  )
                                : path_1.default.resolve(
                                      File.imagesFullPath,
                                      ''.concat(params.filename, '.jpg')
                                  );
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [
                            4 /*yield*/,
                            fs_1.promises.readdir(File.imagesFullPath),
                        ];
                    case 1:
                        return [
                            2 /*return*/,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [
                            4 /*yield*/,
                            fs_1.promises.access(File.imagesThumbPath),
                        ];
                    case 1:
                        _b.sent();
                        return [3 /*break*/, 3];
