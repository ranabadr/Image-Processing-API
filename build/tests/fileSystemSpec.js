...
describe('Test image processing', function () {
    it('invalid width value', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fileSystem_1.default.createThumb({
                        filename: 'foo',
                        width: '-100',
                        height: '500'
                    })];
    ...
    it('filename does not exist', function () { return __awaiter(void 0, void 0, void 0, function () {
        var error;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fileSystem_1.default.createThumb({
    ...
    it('succeeds to write resized thumb file (existing file, valid size values)', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, fileSystem_1.default.createThumb({ filename: 'fjord', width: '99', height: '99' })];
                case 1:
                    _b.sent();
                    resizedImagePath = path_1.default.resolve(fileSystem_1.default.imagesThumbPath, "fjord-99x99.jpg");
                    errorFile = '';
                    _b.label = 2;
                case 2:
                    _b.trys.push([2, 4, , 5]);
