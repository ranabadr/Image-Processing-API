        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [
                        4 /*yield*/,
                        fileSystem_1.default.isImageAvailable(query.filename),
                    ];
                case 1:
                    if (!!_a.sent()) return [3 /*break*/, 3];
                    return [
                        4 /*yield*/,
                        fileSystem_1.default.getAvailableImageNames(),
                    ];
                case 2:
...
pics.get('/', function (req, res) {
    return __awaiter(void 0, void 0, void 0, function () {
        var validationMessage, error, path;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, validation(req.query)];
                case 1:
                    ...
                    return [
                        4 /*yield*/,
                        fileSystem_1.default.isThumbAvailable(req.query),
                    ];
                case 2:
                    if (!!_a.sent()) return [3 /*break*/, 4];
                    return [
                        4 /*yield*/,
                        fileSystem_1.default.createThumb(req.query),
                    ];
                case 3:
                    error = _a.sent();
                    _a.label = 4;
                case 4:
                    ...
                    return [
                        4 /*yield*/,
                        fileSystem_1.default.getImagePath(req.query),
                    ];
                case 5:
                    path = _a.sent();
                    if (path) {
